	...
	<view class="mask flex-center">
		<view class="content botton-radius">
			<view class="content-top">
				...
				<image class="content-top" style="top: 0;" width="100%" height="100%" src="@/static/rt-uni-update/bg_top.png"></image>
			</view>
			<view class="content-header"></view>
			<view class="content-body">
				<view class="title"><text>更新内容</text></view>
				<view class="body">
					<scroll-view class="box-des-scroll" scroll-y="true"><rich-text :nodes="data.version_describe"></rich-text></scroll-view>
				</view>
			...
			<image v-if="cancleBtn" class="close-img" src="@/static/rt-uni-update/app_update_close.png" @click.stop="cancel"></image>
		</view>
	</view>
</template>
...
export default {
	data() {
		return {
			...
			data: {
				...
				package_type: 0, //0是apk升级 1是wgt升级
				edition_url_wgt:''
			}
		};
	},
	...
	methods: {
		...
		download() {
			console.log(this.data.edition_url_wgt)
			
			const downloadTask = uni.downloadFile({
				url: this.data.edition_url_wgt,
				success: res => {
